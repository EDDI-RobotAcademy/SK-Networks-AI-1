...
export type ProductActions = {
    ...
    requestCreateProductToDjango(context: ActionContext<ProductState, unknown>, payload: {
        product_name: string, price: string, product_description: string
...
const actions: ProductActions = {
    ...
    async requestCreateProductToDjango(context: ActionContext<ProductState, unknown>, payload: {
        ...
        const { product_name, price, product_description } = payload
        console.log('전송할 데이터:', { product_name, price, product_description })
        ...
        try {
            ...
            const res: AxiosResponse = await axiosInst.djangoAxiosInst.post(
                '/product/register', { product_name, price, product_description})
