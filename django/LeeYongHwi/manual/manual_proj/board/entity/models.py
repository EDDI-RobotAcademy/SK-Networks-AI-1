...
class Board(models.Model):
    boardId = models.AutoField(primary_key=True)  # AutoField는 AutoIncrement
    title = models.CharField(max_length=128, null=False)  # VarChar
    writer = models.CharField(max_length=32, null=False)
    content = models.TextField()  # 글자 수 제한이 애매할 때 TextField
    ...
    # django가 자기 멋대로 요상한 이름의 테이블을 자동 생성
