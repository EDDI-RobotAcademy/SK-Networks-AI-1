...
class AccountView(viewsets.ViewSet):
    ...
    def checkEmailDuplication(self, request):
        ...
        try:
            ...
            return Response({ 'isDuplicate': isDuplicate, 'message': 'Email이 이미 존재함' if isDuplicate else 'Email 사용 가능' },
    ...
    def checkNicknameDuplication(self, request):
        ...
        try:
            ...
            return Response({ 'isDuplicate': isDuplicate, 'message': 'Nickname이 이미 존재함' if isDuplicate else 'Nickname 사용 가능' },
                           status=status.HTTP_200_OK)
        except Exception as e:
