"""
Django settings for llm_class_django project.
...
SECRET_KEY = 'django-insecure-j!8*3a7jaaf%hans^2o22vtk7==dkfc5@_$y&f!^y^di$4i#8*'
...
ROOT_URLCONF = 'llm_class_django.urls'
...
WSGI_APPLICATION = 'llm_class_django.wsgi.application'
