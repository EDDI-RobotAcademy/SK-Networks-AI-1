...
class Board(models.Model):
    ...
    title = models.CharField(max_length = 128, null = False) # 글자 수가 적어서 제한할 수 있을 때 CharField() 사용, null = False 는 null 값을 허용하지 않겠다는 뜻.
    writer = models.CharField(max_length = 32, null = False)
    content = models.TextField() # 글자 수가 얼마나 들어올지 애매할 때 TextField(). 많은 글이 들어올 수도 있을 때 활용
