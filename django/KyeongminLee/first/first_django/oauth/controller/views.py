...
from oauth.serializer.kakao_oauth_access_token_serializer import KakaoOauthAccessTokenSeriailzer
...
class OauthView(viewsets.ViewSet):
    ...
    def kakaoAccessTokenURI(self, request):
        serializer = KakaoOauthAccessTokenSeriailzer(data=request.data)
        serializer.is_valid(raise_exception=True)
