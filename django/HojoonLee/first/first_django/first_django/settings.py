...
import os
# dotenv는 반드시 pip install python-dotenv로 해야함 pip install dotenv하면 망함
...
SECRET_KEY = "django-insecure-^unkm&+isk$j2(ubuy9+tkhnwbk6q4p(3bbgrj@c63hiaqfmig"
