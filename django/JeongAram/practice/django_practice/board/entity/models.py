...
class Board(models.Model):
    ...
    content = models.TextField() # 문자가 긴 경우 TextField
    regDate = models.DateTimeField(auto_now_add=True)   # 추가하는 시점의 시간 기록하세요
    updDate = models.DateTimeField(auto_now=True)       # 변경하는 시점의 시간 기록하세요

    def __str__(self):  # print(인스턴스) 를 자동으로 반환해준다
        return self.title # 이름
