...
# 놓친 것이 무엇이냐 하면 Product를 어떤 구성으로 만들 것이냐입니다.
# 요구사항이 명확하다면 이 부분이 어느 정도 결정적이지만
# 요구사항이 없기 때문에 어떤 구성으로 할 것인지
# 만들면서 변할 수도 있습니다.

# ex) 만들다보니 사람들이 XXX 라는 기능을 좋아하는 것으로 판단 됨
#     그래서 다른 이것을 좀 더 수월하게 가능하도록
#     엔티티 파트에 뭔가를 추가하는 작업이 발생할 수도 있습니다.
#     (단 Entity의 오염은 발생시키면 안됩니다)
