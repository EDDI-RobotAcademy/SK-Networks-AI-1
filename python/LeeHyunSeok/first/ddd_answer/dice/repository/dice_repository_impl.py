...
#반드시 인터페이스 클래스에 있는 함ㄱ수들을 만들어줘야 합니다.
...
class DiceRepositoryImpl(DiceRepository):
    ...
    __instance = None
    #위의 __instance는 실질적으로 DiceRepository 구현체가 존재하느냐 아니냐를 보는 부분입니다.


    #__new__를 보면 제일 이상한 부분이 보이는데 cls라는 것입니다.
    #도대체 cls는 무엇일까요?
    #보편적으로 cls는 클래스와 매서드가 서로 참조하기 위해 사용하는 내부 인자입니다.
    #self랑은 무슨 관계지? 라는 생각이 보편적으로 들 수 있습니다.
    #원래 객체화가 되었다면 self를 사용했겠지만
    #__new__()를 진행하는 과정에서 아직 객체화가 완료괴지 않았습니다.
