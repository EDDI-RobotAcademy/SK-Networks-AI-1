...
# 반드시 인터페이스 클래스에 있는 함수들을 만들어 줘야 합니다.
class DiceRepositoryImpl(DiceRepository):
    ...
    # 위의 __instance는 실질적으로 DiceRepository 구현체가 존재하는냐 마느냐를 보는 부분입니다.

    # __new__를 보면 제일 이상한 부분이 cls입니다
    # cls?
    # 보편적으로 cls는 쿨래스와 메서드가 서로 참조하기 위해 사용하는 내부 인자입니다.
    # self랑은 무슨관계?
