...
async def injectTfIdfBowSeirvce() -> TfIdfBowServiceImpl:
...
# cosine_similarity()를 활용하여 messageVector와 countMatrix 사이의 유사도를 계산합니다.
...
# 즉 기준을 대상으로 90도가 되면 연관이 없다 판정합니다.
