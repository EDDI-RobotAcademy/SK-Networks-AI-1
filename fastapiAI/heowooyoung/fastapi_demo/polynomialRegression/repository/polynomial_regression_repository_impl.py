...
class PolynomialRegressionRepositoryImpl(PolynomialRegressionRepository):
    ...
    def regressionAnalysis(self, X, y):
        ...
        polynoialFeature = PolynomialFeatures(degree=2)
        X_Polynomial = polynoialFeature.transform(X)

        # 선형 회귀 분석의 경우 선형적인 '수학적'으로 '선형'적인 회귀 분석을 의미한
        ...
        X_new_poly = polynoialFeature.transform(X_new)
