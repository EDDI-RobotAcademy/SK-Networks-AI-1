...
# DTO (request_from, request, response, response_form)도 필요함
# DTO 라는 용어조차 사실 근본없다 생각하므로
# 우리의 경우엔 request_from, request, response, response_form 으로 구성할 것임

# DTO 라는 용어가 근본없다 생각하는 이유는
# 나중에 현업 수준으로 구성이 커지게 되면 requset도 엄청나게 많아지고
