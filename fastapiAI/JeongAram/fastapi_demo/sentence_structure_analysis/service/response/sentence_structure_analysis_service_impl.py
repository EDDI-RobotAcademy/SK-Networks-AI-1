from sentence_structure_analysis.repository.sentenc_structure_analysis_repository_impl import \
    SentenceStructureAnalysisRepositoryImpl
from sentence_structure_analysis.service.response.sentence_structure_analysis_service import \
    SentenceStructureAnalysisService
