...
# cos의 특성상 -1 ~ 1 의 범주를 가지며 어차피 음수는 필요가 없으므로 0 ~ 1 사이의 값을 가지고 계산합니다.
...
async def findSimilarityDocument(tfIdfBowRequestForm: TfIdfBowRequestForm,
    ...
    foundSimilarityDocumentList = tfIdfBowService.findSimilarityDocumentList(tfIdfBowRequestForm.userSendMessage)
