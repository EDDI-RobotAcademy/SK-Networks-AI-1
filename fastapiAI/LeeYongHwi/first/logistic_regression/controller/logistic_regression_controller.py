...
def logistic_regression_test():
    ...
    # 기본적은 접근은 x 값에 대해 최소 오차가 얼마인지, y 값에 대한 최소 오차가 얼마인지를 판별하기 위해
    # 특정 방향 도함수(편미분)를 사용해야 하는 것임
    ...
    # 결록적으로 회귀 분석에 대해 여러 종류가 있는 이유는 여러 다양한 형태의 그래프를 표현하기 위해서임
    # 그리고 그 판단은 어쩔 수 없이 사람이 결정해줘야 함
    # 무엇이 이 데이터에 더 적합한지
