from sentence_structure.repository.sentence_structure_analysis_repository_impl import \
    SentenceStructureAnalysisRepositoryImpl
from sentence_structure.service.sentence_structure_analysis_service import SentenceStructureAnalysisService
