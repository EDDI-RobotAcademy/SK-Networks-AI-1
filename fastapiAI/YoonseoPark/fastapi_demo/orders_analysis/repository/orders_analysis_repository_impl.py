...
# 인공신경망(Artificial Nerual Network)은 사람의 뇌 신경망을 모방하여 만들어진 시스템입니다.
...
class OrdersAnalysisRepositoryImpl(OrdersAnalysisRepository):
    ...
    async def fitModel(self, model, X_train, y_train):
        model.fit(X_train, y_train, epochs=500, validation_split=0.2, batch_size=32, verbose=0)
