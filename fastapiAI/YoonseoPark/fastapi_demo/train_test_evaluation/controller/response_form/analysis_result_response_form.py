...
# 근데 '솔직히 왜 만드는지 모르겠음' 라고 생각할 수 있음
...
# 퉁치는 경우를 생각해보자. 전부 다 하나에 때려박은 다음에 보냈다.
# 근데 새로운 비즈니스 및 마케팅에 의해 보내줘야 하는 정보의 내용이 추가되었다.
# 혹은 일부는 빼내야하고 버려야한다.
# 재밌게도 마케팅이랑 것이 이것도 해보고 저것도 해보고 사람들 반응도 보고 하다보면
...
# 반대로 ReqeustForm의 경우도 있는데
# 웹 페이지에서 보내는 정보가 특정 Domain에 국한된 것이 아니라
# 여러 Doamin 정보가 한 번에 몰려 들어올 수 있기 때문입니다.
# 대표적으로 주문(Order)라는 것이 역시 그러합니다.
# 주문 시 주문과 관련한 정보로 주문번호, 주문고객, 주문상품, 결제금액, 배송 관련 등등의 정보들이 전부 결합 될 수 밖에 없습니다.
...
# 이전에도 적었듯이 이런 작업들이 많아지면 DTO도 좀 불편해지기 때문에 응답과 요청을 나눕니다.
