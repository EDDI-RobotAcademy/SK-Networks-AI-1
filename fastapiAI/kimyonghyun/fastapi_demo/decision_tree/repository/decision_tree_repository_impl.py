...
from decision_tree.repository.decision_tree_reposiotory import DecisionTreeRepository
...
class DecisionTreeRepositoryImpl(DecisionTreeRepository):
    ...
    def sliceTensor(self, scaledTrainDataFrame, scaledTestDataFrame):
        ...
        # tensorflow 사용 primitives로 구성하기 위해 필요한 라이브러리이다.
        # 결론적으로 pandas 데이터를 tensorflow 데이터로 만들 때 사용한다고 파악하면 됩니다.
