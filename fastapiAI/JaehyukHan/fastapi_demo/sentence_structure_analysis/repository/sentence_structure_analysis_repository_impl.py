...
from sentence_structure_analysis.repository.sentence_structure_analysis_repository import SentenceStructureAnalysisRepository
...
class SentenceStructureAnalysisRepositoryImpl(SentenceStructureAnalysisRepository):
    ...
    def sentenceAnalysis(self, text):
        print(f"repository -> sentenceAnalysis(): {text}")
