...
from sentence_structure_analysis.service.sentence_structure_analysis_service_impl import SentenceStructureAnalysisServiceImpl
...
async def sentenceTokenize(sentenceRequestForm: SentenceRequestForm,
    ...
    print(f"controller -> sentenceTokenize(): sentenceRequestFrom:{sentenceRequestForm}")
