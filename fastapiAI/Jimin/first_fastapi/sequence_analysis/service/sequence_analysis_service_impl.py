...
class SequenceAnalysisServiceImpl(SequenceAnalysisService):
    ...
    def predictNextSequence(self, userSendMessage):
        tokenizer = self.sequenceAnalysisRepository.tokenize(userSendMessage)
        ...
        generatedText = self.sequenceAnalysisRepository.generateText("오늘도", 2, trainedModel, maxSequenceLength, tokenizer)
