from plynomialRegrssion.repository.polynomial_regression_repository_impl import PolynomialRegressionRepositoryImpl
from plynomialRegrssion.service.polynomial_regression_service import PolynomialRegressionService
import numpy as np
