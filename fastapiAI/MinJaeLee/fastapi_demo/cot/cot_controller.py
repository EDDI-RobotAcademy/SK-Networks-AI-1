...
async def answerWithCoT(cotReqeustForm: CotRequestForm):
    print(f"controller -> answerWithCoT(): cotRequestForm: {cotReqeustForm}")
    ...
    response = cot_chain.run(cotReqeustForm.userSendQuestion)
