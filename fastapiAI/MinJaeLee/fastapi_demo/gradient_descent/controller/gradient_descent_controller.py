...
async def gradientDescentPredict(requestForm: PredictRequestForm, gradientDescentService: GradientDescentServiceImpl =
Depends(injectGradientDescentService)):
    ...
    return JSONResponse({"predictions": predictions}, status_code=status.HTTP_200_OK)
