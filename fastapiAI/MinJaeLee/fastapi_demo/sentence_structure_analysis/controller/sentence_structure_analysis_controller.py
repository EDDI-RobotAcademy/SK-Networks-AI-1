...
async def sentenceTokenize(sentenceRequestForm: SentenceRequestForm,
                           sentenceStructrueAnalysisService: SentenceStructureAnalysisServiceImpl = Depends(
                               injectSentenceStructureAnalysisService)):
    print(f"controller -> sentenceTokenize(): sentenceRequestForm: {sentenceRequestForm}")

    analyzedResult = sentenceStructrueAnalysisService.sentenceTokenize(sentenceRequestForm.toSentenceRequest())
...
async def wordTokenize(sentenceRequestForm: SentenceRequestForm,
                       sentenceStructureAnalysisService: SentenceStructureAnalysisServiceImpl = Depends(
                           injectSentenceStructureAnalysisService)):
