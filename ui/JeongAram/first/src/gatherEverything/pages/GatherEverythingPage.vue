<template>
    <v-container>
        <h2>Deep Learning Local Server Test</h2>
        <v-btn color="primary" @click="onClickRollDice">딥러닝 학습 시작 버튼</v-btn>
        <v-btn color="secondary" @click="onClickListDice">딥러닝 추론 시작 버튼</v-btn>
        <v-btn color="primary" @click="onClickGetResult">딥러닝 결과 확인 버튼</v-btn>
    </v-container>
</template>
...
export default {
    methods: {
        ...
        onClickRollDice () {
            console.log("학습 버튼 누름")
            this.requestAICommandToFastAPI(1)
