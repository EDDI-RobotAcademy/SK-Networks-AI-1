...
export type CartActions = {
    requestAddCartToDjango(
        ...
        cartData: CartItem):Promise<AxiosResponse>
    requestCartListToDjango(
        context: ActionContext<CartState, any>): Promise<AxiosResponse>;

}

const actions: CartActions = {
    async requestAddCartToDjango({commit}, cartData: CartItem):Promise<AxiosResponse> {
        try {
