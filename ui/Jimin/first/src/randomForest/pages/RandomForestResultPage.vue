<template>
    <v-container v-if="confusionMatrixInfoBeforeSmote && confusionMatrixInfoAfterSmote">
        ...
        <v-row>
            <v-col cols="6">
                <common-chart :title="`Passengers Number vs Booking Complete`"
            ...
            <v-col cols="6">
                <common-chart :title="`Passengers Lead vs Booking Complete`"
            ...
            <v-col cols="6">
                <common-chart :title="`Length of Stay vs Booking Complete`"
            ...
            <v-col cols="6">
                <common-chart :title="`Wants Extra Baggage vs Booking Complete`"
            ...
            <v-col cols="6">
                <common-chart :title="`Wants Preferred Seat vs Booking Complete`"
            ...
            <v-col cols="6">
                <common-chart :title="`Wants In-Flight Meals vs Booking Complete`"
