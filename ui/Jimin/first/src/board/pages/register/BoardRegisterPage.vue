        ...
        <v-row>
            <v-col cols="12">
                <!-- v-model은 기본적으로 양방향으로 데이터를 주고 받을 수 있음
                    그렇기 때문에 v-model="title"은 script내부에 있는 data인 title에 영향을 줌
                    이와 동일한 방식으로 v-model은 양쪽을 모두 맵핑할 수 있습니다. -->
...
export default{
    ...
    methods: {
        ...
        // 쉽게 말해서 requestCreateBoardToDjango가 boardModule의 action에 정의되어야 한다는 말
        ...
        async onSubmit () {
            ...
            // console.lot('payload check:', payload)
