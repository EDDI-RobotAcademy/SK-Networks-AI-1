<template>
    <v-container class="chart-container">
        ...
        <svg ref="svg" :viewBox="`0 0 ${svgWidth} ${svgHeight}`"
                        preserveAspertRatio="xMidYmid meet">
        </svg>
        <div class="report">
            <h2>Classficiation Report</h2>
...
export default {
    ...
    async created () {
        try{
            ...
            // 현재 d3와 fastapi, 딥러닝 hard skll(기능) 자체에 집중하기 때문에
            ...
            this.drawConfusionMatrix(data.confusionMatrix)

            this.classificationReport = data.classificationReport
