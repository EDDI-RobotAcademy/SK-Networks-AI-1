<template>
    <v-container>
        <h2>안녕 Vue3 TypeScript3 기반 Board App이야!</h2>
        <div style="
...
export default {
    ...
    //create의 경우 vue컴포넌트(객체)를 생성할 때 구동하며
    //mounted는 vue컴포넌트 생성 이후 값들을 붙일 때 구동됩니다.
    //실제로 없는 가상의 정보를 생성하여 붙인다 생각하면 좋습니다.
    //대표적으로 html태그에 없던  위의 v-data-table 같은 것입니다.
