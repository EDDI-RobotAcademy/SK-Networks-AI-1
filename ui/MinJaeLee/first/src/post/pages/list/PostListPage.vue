<template>
    <v-container>
        ...
        <v-pagination v-model="pagination.page" :length="Math.ceil(postList.length / perPage)" color="primary" />
    </v-container>
</template>
...
export default {
    ...
    data() {
        return {
            headerTitle: [
                { title: 'No', align: 'start', sortable: true, key: 'id', width: "20%", },
                { title: '제목', align: 'start', key: 'title', width: "80%", },
            ],
            perPage: 10,
            pagination: {
                page: 1,
