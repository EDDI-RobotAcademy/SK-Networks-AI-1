        ...
        <v-row>
            <v-col cols="12">
                <!-- v-model은 기본적으로 양방향으로 데이터를 주고 받을 수 있음.
                 ...
                 이와 동일한 방식으로 v-model은 양쪽을 모두 맵핑할 수 있음.-->
...
export default {
    ...
    methods: {
        ...
        // 쉽게 얘기해서 requestCreateBoardToDjango 가 boardModule의 action에 정의되어야 한다는 말
        ...
        async onSubmit () {
            ...
            // 글 작성이 완료되었다면 보편적으로 작성한 글을 볼 수 있는 읽기
            // 아직 Read 구현 안했으니까 여기선 우선 정지
