...
export default {
    ...
    async created () {
        try {
            ...
            // console.log('1111', data.classification_report)
    ...
    methods: {
        drawConfusionMatrix (matrix) {
            ...
            svg.append('g')
                    ...
                    .selectAll('rect')
                    .data(matrix.flat())
                    .enter().append('rect') // 사각형에 대한 속성 지정
